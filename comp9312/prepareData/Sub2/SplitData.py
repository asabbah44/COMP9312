...
IncludeDesign,ExcludeDes = train_test_split(df_in_design, test_size=0.70, random_state=0)
IncludeImplementation,ExcludeImp = train_test_split(df_in_implementation, test_size=0.40, random_state=0)
IncludeDef,ExcludeDef = train_test_split(df_in_defect, test_size=0.30, random_state=0)
